...
struct EnhancedContentView: View {
    ...
    @State private var conversationHistory: [EnhancedConversationItem] = []
    ...
    private func startRecording() {
        ...
        let userMessage = EnhancedConversationItem(
            id: UUID(),
            type: .user,
            content: "🎤 녹음 중...",
            timestamp: Date(),
        ...
        Task {
            ...
            await MainActor.run {
                if let response = aiService.lastResponse {
                    ...
                    let aiResponse = EnhancedConversationItem(
                        id: UUID(),
                        type: .ai,
...
struct EnhancedConversationBubble: View {
    let item: EnhancedConversationItem
...
struct EnhancedConversationItem: Identifiable {
    let id: UUID
